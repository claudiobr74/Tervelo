...
function athleteOwn(
  ...
  if (opts.update) {
    userOps.update = {
      filter: OWN,
      columns: Array.isArray(opts.update) ? opts.update : withoutMeta(columns, ["user_id"]),
    };
  }
  if (opts.delete) {
...
export const PUBLIC_TABLES: PublicTable[] = [
    ...
    permissions: [
      {
        ...
        operations: {
          ...
          insert: {
            filter: PROGRAM_OWNER,
            columns: ["program_id", "position", "name", "intent", "starts_on", "ends_on"],
          },
          update: {
            filter: PROGRAM_OWNER,
            columns: ["position", "name", "intent", "starts_on", "ends_on"],
          },
        },
      },
      {
    ...
    permissions: [
      {
        ...
        operations: {
          ...
          insert: {
            filter: { block: PROGRAM_OWNER },
            columns: ["block_id", "week_index", "notes"],
          },
  ...
  },
  {
    ...
    objectRelationships: [{ name: "wearable_device", column: "wearable_device_id" }],
    permissions: athleteOwn(
      [
        "id",
        "user_id",
  ...
  },
  {
    ...
    permissions: [
      {
        role: "user",
        operations: { select: { filter: OPEN, columns: ["id", "slug", "created_at"], limit: 20 } },
      },
      {
        role: "admin",
        operations: { select: { filter: OPEN, columns: ["id", "slug", "created_at"], limit: 50 } },
      },
      {
        role: "super_admin",
        operations: {
  ...
  },
  {
    ...
    columns: [
      ...
      "pain_region",
      "pain_intensity",
      "pain_worsens_with_movement",
      "pain_blocks_planned_exercise",
      "has_planned_time",
      "available_minutes",
      "client_mutation_id",
      "created_at",
  ...
  },
  {
    ...
    columns: [
      ...
      "body_composition_state",
      "body_composition_confidence",
      "heart_rate_state",
      "heart_rate_enabled",
  ...
  },
  {
    ...
    objectRelationships: [{ name: "athlete_state_snapshot", column: "athlete_state_snapshot_id" }],
    arrayRelationships: [
  ...
  },
  {
    ...
    columns: [
      ...
      "follow_up_period_start",
      "follow_up_period_end",
      "follow_up_performance_json",
      "follow_up_recovery_json",
      "follow_up_adherence_json",
      "follow_up_nutrition_json",
      "follow_up_body_json",
      "created_at",
      "updated_at",
    ],
  ...
  },
  {
    ...
    permissions: athleteOwn(["id", "user_id", "type", "payload", "read_at", "created_at"], {
      insert: false,
      update: ["read_at"],
      delete: false,
    }),
